...
exports.REASONS = {INTERNAL: "internal", BAD_MODEL: "badmodel", OK: "ok", VALIDATION:"badrequest", 
    LIMIT: "limit", NOKNOWLEDGE: "noknowledge", NOTCHATAI: "notchatai", NO_JOB: "nojob"};
...
exports.answer = async function(query, id, org, aiappid, request, flow_section=exports.DEFAULT_LLM_FLOW) {
    ...
    let __notASBNodeCount = 0; for (const llmflowCommandDefinition of llmflowCommands) {
    ...
    if (__notASBNodeCount == llmflowCommands.length) for (let i = 0; i < 10; i++) LOG.warn(`****** [[SERIOUS!!!]] ${aiappid} NOT USING ASB FOR AI FLOWS - THIS IS NOT RECOMMENDED.`);
